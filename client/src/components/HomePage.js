...
export default props => {
  ...
  return (
    <div>
      ...
      <Text>
        An anti-podcast podcast. Subscribe at:{' '}
        <a href="https://itunes.apple.com/us/podcast/long-live-the-new-sound/id1393853495?mt=2">
          ITunes
        </a>{' '}
      ...
      <SubmitForm />
      <HeaderSmall>About & Submission Guidelines</HeaderSmall>
      <Text>
        This is a podcast for artists, archivists, producers and other
        interested parties to share and hear work that experiments in sound.
      ...
      <Text>
        Note that while we want to include almost all the submissions that come
        through, we are screening to make sure the work meets our stated
        guidelines, does not include hateful content, and is in the spirit of
        experimentation. Please bear with us as we figure out what exactly that
        means.
      </Text>
      ...
      <Text>
        ...
        nobody intends to. The artist maintains all the right to their own work.
        <br />
        ...
        episode description. We also ask that you include an email address in
        case we need to contact you about the work - your contact information
        will not be included in the podcast description unless you want it to.
      </Text>
      <HeaderSmall>About the Show</HeaderSmall>
      <Text>
        We aren’t a show in the traditional sense. There is no host, no weekly
        theme, no ads, no clock and no release schedule. Instead this is an
        ongoing space where different kinds of audio is being perpetually being
        submitted and added to the catalogue. Think of it like a playlist where
        you download or stream for as long as you like, listen actively,
        passively, on your commute or in your shower. No interruptions from DJs,
        hosts or ad breaks.
      </Text>
      <HeaderSmall>Who are we?</HeaderSmall>
      <Text>A couple of people who enjoy listening.</Text>
